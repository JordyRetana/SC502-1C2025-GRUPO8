<?php
// Puedes colocar este código al inicio de tu archivo PHP
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
<button class="back-button" onclick="window.location.href='/FINAL/Plataforma/pages/home.php'"></button>
      ...
      <div class="display_div">
        <div class="screen_out">
          <div class="screen_out1">
            <div class="screen">
              <span class="notfound_text">En contruccion :)</span>
            </div>
          </div>
        </div>
      </div>
