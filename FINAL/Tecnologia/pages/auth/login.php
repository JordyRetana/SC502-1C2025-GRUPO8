<?php
$cssFile = "/FINAL/Tecnologia/assets/css/auth/login.css";
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
  <form class="form" id="loginForm">
    <div class="title">Hola de nuevo,<br><span>inicia sesión para continuar</span></div>
    ...
    <div class="login-with">
      ...
      <div class="button-log">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 56.6934 56.6934">
      ...
      <div class="button-log">
        <svg class="icon" viewBox="0 0 56.693 56.693">
    ...
    <button class="button-confirm" style="margin-top: 20px;" onclick="window.location.href='../../pages/auth/registrer.php'; return false;">
      Crear cuenta
    </button>
  </form>
...
if (loginForm) {
    loginForm.addEventListener("submit", function (e) {
        ...
        if (password.length < 6) return mostrarMensaje("Contraseña debe tener al menos 6 caracteres");
        ...
        .then(data => {
            ...
            if (data.status === "success") {
                setTimeout(() => {
                    window.location.href = data.redirect || "/FINAL/Tecnologia/pages/home.php";
                }, 1000);
            }
        })
        .catch(error => {
            console.error("Error:", error);
            mostrarMensaje(error.message || "Error en el servidor");
        });
    });
}
  </script>
