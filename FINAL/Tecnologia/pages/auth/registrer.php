<?php
$cssFile = "/FINAL/Tecnologia/assets/css/auth/register.css";
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
  <form class="form" id="registerForm" method="POST">
    ...
    <input class="input" name="name" placeholder="Nombre" type="text" required>
    ...
    <button class="button-confirm" type="submit">Registrarse →</button>
  ...
  <script>
    ...
    if (registerForm) {
      registerForm.addEventListener("submit", function (e) {
        ...
        fetch("http://localhost/FINAL/Tecnologia/api/auth/register.php", {
                method: "POST",
                body: formData
                })
                .then(response => {
                ...
                if (data.status === 'success') {
                    ...
                    setTimeout(() => {
                    window.location.href = '/FINAL/Tecnologia/pages/auth/login.php';
                    }, 2000);
                } else {
                ...
                mostrarMensaje(error.message || "Hubo un error, por favor intenta de nuevo.");
                });
